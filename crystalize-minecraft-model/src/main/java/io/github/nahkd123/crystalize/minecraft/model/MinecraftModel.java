...
public record MinecraftModel(ResourceLocation parent, Map<DisplaySlot, DisplayTransformation> display, Map<String, ResourceLocation> textures, GuiLight guiLight, List<MinecraftModelElement> elements) {
